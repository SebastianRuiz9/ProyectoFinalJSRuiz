    ...
    const vaciarCarrito = () => {
        ...
        Swal.fire({
            ...
            imageUrl: "https://i.pinimg.com/originals/a6/6d/c9/a66dc9b8fc1c1339e961f1692bf7eb73.jpg",
            imagewidth: 20,
    ...
    const renderCarrito = () => {
        ...
        productos.forEach(producto => {
            contenidoHTML += `<tr class="mt-3">
                ...
                <td class="align-middle"> <img src="img/trash.svg" alt="Eliminar" width="24" onclick="eliminarProducto(${producto.id})" </td>
            </tr>`;
        });
    ...
    const eliminarProducto = (id) => {
        ...
        Swal.fire({
            ...
            footer: 'Pero te iba a quedar flama, yo que vos lo vuelvo a agregar'
          });
